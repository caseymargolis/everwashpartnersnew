...
$(document).ready(function() {
  const testimonialData = {
    ...
    general: [
      { name: "Tim Terrizzi", company: "Pit Stop Car Wash", subtitle: "Full Service Car Wash / Philadelphia PA", text: "\"If I've struggled, I could reach out to anyone for advice, resources, whatever, and there's a dialogue…I appreciate that aspect of EverWash probably above anything else.\"", avatar: "/assets/images/tim-terrizzi.png" },
      { name: "Taylor Irwin", company: "Rocky Mountain Car Wash", subtitle: "Automatic and Self Serve Washes / Rocky Mountains", text: "\"EverWash is the type of partner that listens to their customers, implements change to stay competitive, and truly cares about the operator's success and growth.\"", avatar: "/assets/images/taylor-irwin.png" },
      { name: "Allan Scozzari", company: "Purple Elephant Car Wash", subtitle: "Express Car Wash / Middletown CT", text: "\"EverWash has helped grow my membership program by 60%, providing a steady income stream from customers who see the value in regular car washes.\"", avatar: "/assets/images/allan-scozzari.png" }
    ]
  };
